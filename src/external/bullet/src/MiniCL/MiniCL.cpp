...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueReadBuffer( cl_command_queue command_queue, cl_mem buffer,
		cl_bool /* blocking_read */, size_t offset, size_t cb, void * ptr, cl_uint /* num_events_in_wait_list */,
...
CL_API_ENTRY cl_int clGetProgramBuildInfo( cl_program /* program */, cl_device_id /* device */,
...
// Program Object APIs
CL_API_ENTRY cl_program clCreateProgramWithSource( cl_context context, cl_uint /* count */, const char ** /* strings */,
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueWriteBuffer( cl_command_queue command_queue, cl_mem buffer,
		cl_bool /* blocking_read */, size_t offset, size_t cb, const void * ptr, cl_uint /* num_events_in_wait_list */,
		const cl_event * /* event_wait_list */, cl_event * /* event */) CL_API_SUFFIX__VERSION_1_0
{
	MiniCLTaskScheduler* scheduler = (MiniCLTaskScheduler*)command_queue;
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueNDRangeKernel( cl_command_queue /* command_queue */, cl_kernel clKernel,
...
//		int numWorkItemsPerTask = btMax(64,numWorkItems / maxTask);
		...
		if (!numWorkItemsPerTask)
			numWorkItemsPerTask = 1;
...
static void* localBufMalloc( int size )
{
	...
	{ // reset
		...
		while ((unsigned long)spLocalBufCurr & 0x0F)
			spLocalBufCurr++; // align to 16 bytes
		sLocalBufUsed = 0;
	}
...
CL_API_ENTRY cl_int CL_API_CALL clSetKernelArg( cl_kernel clKernel, cl_uint arg_index, size_t arg_size,
...
CL_API_ENTRY cl_int CL_API_CALL clBuildProgram( cl_program /* program */, cl_uint /* num_devices */,
		...
		void (*pfn_notify)( cl_program /* program */, void * /* user_data */), void * /* user_data */) CL_API_SUFFIX__VERSION_1_0
{
	return CL_SUCCESS;
}

CL_API_ENTRY cl_program CL_API_CALL clCreateProgramWithBinary( cl_context context, cl_uint /* num_devices */,
...
CL_API_ENTRY cl_command_queue CL_API_CALL clCreateCommandQueue( cl_context context, cl_device_id /* device */,
		cl_command_queue_properties /* properties */, cl_int * errcode_ret ) CL_API_SUFFIX__VERSION_1_0
{
	*errcode_ret = 0;
...
CL_API_ENTRY cl_context CL_API_CALL clCreateContextFromType( const cl_context_properties * /* properties */,
		cl_device_type device_type, void (*pfn_notify)( const char *, const void *, size_t, void * ) /* pfn_notify */,
...
//	int maxNumOutstandingTasks = 1;
	...
	static const char* sUniqueThreadSupportName[maxNumOfThreadSupports] = { "MiniCL_0", "MiniCL_1", "MiniCL_2", "MiniCL_3",
			"MiniCL_4", "MiniCL_5", "MiniCL_6", "MiniCL_7" };

	btThreadSupportInterface* threadSupport = 0;

	if (device_type == CL_DEVICE_TYPE_DEBUG)
	{
		SequentialThreadSupport::SequentialThreadConstructionInfo stc( "MiniCL", processMiniCLTask,
...
#ifdef USE_PTHREADS
		PosixThreadSupport::ThreadConstructionInfo constructionInfo( "PosixThreads", processMiniCLTask,
				createMiniCLLocalStoreMemory, maxNumOutstandingTasks );
...
clCreateContext( const cl_context_properties * properties, cl_uint num_devices, const cl_device_id * devices,
		void (*pfn_notify)( const char *, const void *, size_t, void * ), void * user_data, cl_int * errcode_ret ) CL_API_SUFFIX__VERSION_1_0
{
...
extern CL_API_ENTRY cl_int CL_API_CALL
clGetKernelWorkGroupInfo( cl_kernel kernel, cl_device_id /* device */, cl_kernel_work_group_info wgi/* param_name */,
		size_t sz /* param_value_size */, void * ptr /* param_value */, size_t * /* param_value_size_ret */) CL_API_SUFFIX__VERSION_1_0
{
	if ((wgi == CL_KERNEL_WORK_GROUP_SIZE) && (sz == sizeof(size_t)) && (ptr != NULL))
	{
