...
public:
	...
	*/
	...
	//SIMD_FORCE_INLINE btVector3(const glm::detail::tvec3<float> v);
	//SIMD_FORCE_INLINE btVector3(const glm::detail::tvec4<float> v);
	
	// @ShadowFox
	SIMD_FORCE_INLINE btScalar& operator[](const unsigned int i)
	{
		return m_floats[i];
	}
