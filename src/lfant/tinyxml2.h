...
public:
	MemPoolT() :
		root(0), currentAllocs(0), nAllocs(0), maxAllocs(0)
	{
	}
	~MemPoolT()
	{
	...
	void Trace(const char* name)
	{
		printf(
			...
			name, maxAllocs, maxAllocs * SIZE / 1024, currentAllocs, SIZE,
			nAllocs, blockPtrs.Size());
	}
