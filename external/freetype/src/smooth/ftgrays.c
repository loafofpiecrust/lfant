...
#define ErrRaster_Invalid_Opcode      -2
#define ErrRaster_Invalid_Outline   -1
#define ErrRaster_Invalid_Argument  -3
#define ErrRaster_Stack_Overflow   -4
...
#define Smooth_Err_Invalid_Opcode     Smooth_Err_Cannot_Render_Glyph
#define Smooth_Err_Stack_Overflow  Smooth_Err_Out_Of_Memory
#define ErrRaster_Stack_Overflow   Smooth_Err_Out_Of_Memory
...
#define SCALED( x )  ( ( (x) << shift ) - delta )
  ...
  gray_convert_glyph( RAS_ARG )
  {
    ...
    for ( n = 0; n < num_bands; n++, min = max )
    {
      ...
      while ( band >= bands )
      {
        ...
        else if ( error != ErrRaster_Stack_Overflow )
          return 1;
                      ...
                      const FT_Raster_Params*  params )
  {
    ...
    if ( !( params->flags & FT_RASTER_FLAG_AA ) )
      return FT_THROW( Invalid_Opcode );
