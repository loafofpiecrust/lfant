...
#define Raster_Err_Raster_Uninitialized      -1
...
#define Raster_Err_Raster_Uninitialized      Raster_Err_Raster_Uninitialized
...
#define ras  (*worker)
                        ...
                        Bool     overshoot )
  {
    ...
    //  ras.error = FT_THROW( Invalid_Opcode );
      return FAILURE;
    }
...
#define SWAP_( x, y )  do                \
  ...
  Render_Single_Pass( RAS_ARGS Bool  flipped )
  {
    ...
    while ( ras.band_top >= 0 )
    {
      ...
      if ( Convert_Glyph( RAS_VARS flipped ) )
      {
        ...
        {
          ras.band_top = 0;
          ras.error    = FT_THROW( Invalid_Opcode ); // @fixme correct?
                   ...
                   const FT_Raster_Params*  params )
  {
    ...
    if ( params->flags & FT_RASTER_FLAG_DIRECT )
      return FT_THROW( Raster_Corrupted );
